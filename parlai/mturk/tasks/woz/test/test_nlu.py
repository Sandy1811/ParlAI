...
class NLUTestCase(unittest.TestCase):
    ...
    def test_basic_io(self):
        ...
        candidates = nlu.get_suggestions("Hello")
        self.assertIsInstance(candidates, list)
        self.assertEqual(len(candidates), 3)

    def test_distinct_pretext(self):
        nlu = NLUServerConnection()
        best_candidate_confirm = nlu.get_suggestions("yes. May I have your name, please?", max_num_suggestions=1)[0]
        best_candidate_deny = nlu.get_suggestions("No. May I have your name, please?", max_num_suggestions=1)[0]
        best_candidate_curtsy = nlu.get_suggestions("You are welcome! May I have your name, please?", max_num_suggestions=1)[0]
