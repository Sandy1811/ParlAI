...
def main():
    ...
    while workers:
        ...
        client.notify_workers(
            Subject="AI Dialogues - Stage II [v3]",
            MessageText="Hello! "
                        ""
                        "As you may have noticed, the AI Dialogues - Stage II [v3] tasks contained a bug that showed you a "
                        "message saying you can accept the task even though your partner has disconnected - and then "
                        "rejects your work. We are very sorry for that and now reverted all rejections whenever possible. "
                        "So your assignment's status should now be switched to 'accepted'. "
                        ""
                        "I also removed all the automatic rejection code, so this should not happen again. Thus, if your "
                        "partner disconnects early, just return the HIT. If the dialogue was pretty much finished and your "
                        "partner disconnects, you can submit and we'll read the dialogue and decide if we accept/reject "
